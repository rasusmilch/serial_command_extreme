...
- Active documentation now reflects the pure help foundation, the implemented optional console built-in route, the descriptor/help model, separate help metadata validation, static visibility policy, descriptor-order LF output, implemented extended sections and topic pages with console topic grammar deferred, and the historical status of the original handoff.
