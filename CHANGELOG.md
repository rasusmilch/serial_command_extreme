...
- Extended-help catalog foundation with borrowed notes, warnings, presentation examples, related descriptor references, flat topic metadata, structural validation diagnostics, pure flat-topic lookup, topic-specific `BSC_STATUS_UNKNOWN_TOPIC`, focused host coverage, configurable-capacity fixture coverage, and preservation of existing generated-help output; extended rendering, topic-page rendering, and console topic grammar remain future work.
